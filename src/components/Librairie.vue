...
//Récupère le paramètre recherche de l'enfant RechercheForm
...
//Récupère les paramètres de l'enfant AjouterLivreForm
...
//DELETE : Supprime un livre. Recupère l'id du livre a supprimer envoyé par l'enfant ListeLivres.vue
